(function (global, factory) {
    ...
    SlideVerify.prototype = {
        ...
        getDragBtnWid:function(){//鑾峰彇婊戝潡鐨勫搴︼紝
            return parseInt(this.slideBtn.width());
        },
        getDragWrapWid:function(){//鑾峰彇  鏈鍣ㄧ殑鐨勫搴︼紝浠ラ槻涓囦竴
        ...
        ifAnimated:function(){//鍒ゆ柇 鏄惁鍔ㄧ敾鐘舵€�
            return this.slideBtn.is(":animated")
        },
        getDragBtnLeft:function(){ //鍒ゆ柇褰撳墠 鎸夐挳 绂诲乏渚х殑璺濈
